...
// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
/\/\/\/\/\/\/\/\/\/\/\/ //
f = k_dFrequencyRef*pow(2, nu + k/k_nHalfTonesInOctave);
}
else
{
...
string getNoteName(int nu, int k)
{
...
// the integer nu.
//
// Use to_string to covert integer nu to a string.
//
...
// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
/\/\/\/\/\/\/\/\/ //
double f = computeFrequency(-5.0, -10.0);
double dWavelengthCentimeters = computeWavelengthInCm(f);
string strNote = getNoteName(-10.0, -5.0);
